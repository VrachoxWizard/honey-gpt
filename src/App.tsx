import { Bot, Menu, Sun, Moon, ArrowDown, Sparkles } from 'lucide-react';
...
function AppContent() {
  ...
  const handleRenameSession = (id: string, newTitle: string) => {
    ...
    showToast('Razgovor preimenovan!', 'success');
  };

  const handleDeleteSession = (id: string) => {
    deleteSession(id);
    showToast('Razgovor obrisan.', 'info');
  };

  const handleClearAllSessions = () => {
    clearAllSessions();
    showToast('Svi razgovori obrisani.', 'info');
  };
